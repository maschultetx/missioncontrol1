...
measure: qm_test {
  ...
  measure: gas_guage_colorful {
    ...
    html:   <img src="https://chart.googleapis.com/chart?chs=250x150&cht=gom&chma=10,0,0,0&chds=0,50&chxt=y&chxr=0,0,2000&chxl=0:|slow|fast&chco=d7f58d,cbf169,beee45,b2eb21,9cd213&chf=bg,s,FFFFFF00&&chd=t:{{ value }}&chl={{ rendered_value }}">;;
  ...
  measure: gas_guage_red {
   ...
   # html:   <img src="https://chart.googleapis.com/chart?chs=200x125&cht=gom&chma=10,0,0,0&chxt=y&chds=0,15&chxr=0,10&chxl=0:|slow|fast&chco=bdddfe,97cafb,70b6fc,4aa3fc,238ffb&chf=bg,s,FFFFFF00&&chd=t:{{ value }}&chl={{ rendered_value }}">;;
