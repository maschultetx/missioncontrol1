...
measure: gas_guage_colorful {
  type: number
    ...
    html:   <img src="https://chart.googleapis.com/chart?chs=475x300&cht=gom&&hds=0,50&chxt=y&chxr=0,0,2000&chxl=0:|slow|fast&chco=d7f58d,cbf169,beee45,b2eb21,9cd213&chf=bg,s,FFFFFF00&&chd=t:{{ value }}&chl={{ rendered_value }}">;;
  ...
  measure: gas_guage_grey {
   ...
   html:   <img src="https://chart.googleapis.com/chart?chs=475x300&cht=gom&chxt=y&chds=0,50&chxr=0,0,2000&chxl=0:|slow|fast&chco=9eafed,7d94e7,5c79e1,3a5edb,2549c9&chf=bg,s,FFFFFF00&&chd=t:{{ value }}&chl={{ rendered_value }}">;;
  ...
  measure: gas_guage_red {
    ...
    html:   <img src="https://chart.googleapis.com/chart?chs=475x300&cht=gom&chxt=y&chds=0,50&chxr=0,0,2000&chxl=0:|slow|fast&chco=bdddfe,97cafb,70b6fc,4aa3fc,238ffb&chf=bg,s,FFFFFF00&&chd=t:{{ value }}&chl={{ rendered_value }}">;;
  }
